...
public class AddNewPathologyWindow_EN extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        avgDurationLabel.setText("Average duration");

        stdDeviationLabel.setText("Standard deviation");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(stdDeviationLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 140, Short.MAX_VALUE)
                    .addComponent(avgDurationLabel, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(pathologyLabel, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        if ("".equals(ptg) || "".equals(avg) || "".equals(std)) {
        ...
        if (buttonPressed == 1) {
            ...
            JOptionPane.showMessageDialog(this, "The datas you introduced are:\n\npathology " + ptg + "\navrage duration " + avg + "\nstandard deviation " + std + "\n", "Check info ", JOptionPane.PLAIN_MESSAGE);
        } else { // buttonPressed = 2;
            buttonPressed = 1;
            if (!pathologyText.equals(ptg) || !avgDurationText.equals(avg) || !stdDeviationText.equals(std)) {
                //datas updated
                pathologyText = ptg;
                avgDurationText = avg;
                stdDeviationText = std;

                JOptionPane.showMessageDialog(this, "The updated data you introduced is:\n\npathology " + ptg + "\navrage duration " + avg + "\nstandard deviation " + std + "\n", "Check info ", JOptionPane.PLAIN_MESSAGE);
                return ;
            }

            //save datas
            buttonPressed = 0;
            PathologiesListPanel_EN.addNewPathologyEntry(ptg, avg, std);
            this.dispose();
        }
...
//            java.util.logging.Logger.getLogger(AddNewPathologyWindow_EN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
